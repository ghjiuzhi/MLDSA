...
#
# Script generated by Vivado on Tue Apr 14 16:54:54 +0800 2026
...
# script info
echo -e "proc_sys_reset_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot proc_sys_reset_0 xil_defaultlib.proc_sys_reset_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Programs/Xilinx2023/Vivado/2023.2/data/xsim"
  fi
