...
module compute_write_add(
	...
	always @(posedge clk) begin
		...
		if (!PQC_mode) begin
			...
			add_num_1_2			<= PWA_PWS_sel ? 23'd8380417 - data_in_1 : data_in_1;
			add_num_2_2			<= PWA_PWS_sel ? 23'd8380417 - data_in_2 : data_in_2;
		end
		else begin
			Write_FIFO_tdata	<= {20'd0, add_result_2[11:0], 20'd0, add_result_1[11:0]};
			add_num_1_2			<= PWA_PWS_sel ? 23'd3329 - data_in_1 : data_in_1;
			add_num_2_2			<= PWA_PWS_sel ? 23'd3329 - data_in_2 : data_in_2;
		end
